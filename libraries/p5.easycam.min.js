    ...
    class f {
        constructor(n, o) {
            ...
            this.cam = p, this.LOOK = [0, 0, 1], this.UP = [0, 1, 0], this.AXIS = new function () {
                ...
                insideViewport: function (q, r) {
                    var u = p.viewport[0], v = u + p.viewport[2], A = p.viewport[1], B = A + p.viewport[3];
                    return q > u && q < v && r > A && r < B
                },
                solveConstraint: function () {
                    var q = this.dist[0], r = this.dist[1];
                ...
                updateInput: function (q, r, u) {
                    var v = p.mouse, A = p.P5.pixelDensity();
                ...
                mousedrag: function () {
                    var q = p.P5.pixelDensity(), r = p.mouse;
                    if (r.ismousedown) {
                        var u = p.P5.mouseX, v = p.P5.mouseY;
                        r.updateInput(u, v, v), r.solveConstraint();
                        var B = r.button & r.BUTTON.LMB, C = r.button & r.BUTTON.MMB, D = r.button & r.BUTTON.RMB;
                ...
                wheel: function (q) {
                    var r = q.x, u = q.y, v = p.mouse;
                    v.insideViewport(r, u) && (v.mwheel = 0.01 * q.deltaY, v.mouseWheelAction && v.mouseWheelAction())
                },
                evaluateTouches: function (q) {
                    var B, C, D, r = q.touches, u = 0, v = 0, A = 0, E = r.length;
                    for (B = 0; B < E; B++) u += r[B].clientX, v += r[B].clientY;
                    for (u /= E, v /= E, B = 0; B < E; B++) C = u - r[B].clientX, D = v - r[B].clientY, A += Math.sqrt(C * C + D * D);
        ...
        attachMouseListeners(n) {
            var o = this.cam, p = o.mouse;
            if (n = n || o.renderer, n) {
                var q = {passive: !1}, r = n.elt;
        ...
        mouseDragRotate() {
            var n = this, o = n.mouse, p = o.curr[0], q = o.curr[1], r = o.dist[0], u = o.dist[1],
        ...
        zoom(n) {
            var o = this.cam, p = o.state.distance + n;
        ...
        beginHUD(n, o, p) {
            ...
            if (n = n || q.renderer, !!n) {
                n.push();
                var r = n.drawingContext, o = void 0 === o ? n.width : o, p = void 0 === p ? n.height : p,
                    u = Number.MAX_VALUE;
    ...
    var k = {
        assert: function (n) {
            ...
            if (o = k.assert(o), n.axis) {
                var p = n.axis, q = n.angle, r = m.mag(p);
                if (0 == r) return;
                var u = -0.5 * q, v = Math.sin(u) / r;
            ...
            if (n.angles_xyz) {
                var B = -0.5 * n.angles_xyz[0], C = -0.5 * n.angles_xyz[1], D = -0.5 * n.angles_xyz[2],
                    E = [Math.cos(B), Math.sin(B), 0, 0], F = [Math.cos(C), 0, Math.sin(C), 0],
...
p5 && (p5.prototype.createEasyCam = function () {
    var c = this._renderer, e = arguments[0];
    ...
    var l = e - c, m = g - f, n = k - j, r = -(e + c) / l, u = -(g + f) / m, v = -(k + j) / n;
